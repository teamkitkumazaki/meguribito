				...
				<ul>
					<?php
						...
						foreach ( $repeat_group as $fields ) {
							...
							$slider_img_sp = $fields['slider_sp'];
						...
						?>
						<li class="slide01" style="background-image: url(<?php echo $thumb_img_sp[0];?>);">
							<img
								class="blur"
								src="<?php echo $thumb_img_pc[0];?>"
								srcset="<?php echo $thumb_img_pc[0];?> 1440w, <?php echo $thumb_img[0];?> 2048w" sizes="100vw"
							>
						</li>
					<?php } ?>
				</ul>
